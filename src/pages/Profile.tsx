...
const Profile = () => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            // Mocking the backend update for now as requested
            // In a real scenario, this would be a PATCH to /api/auth/profile
            await new Promise(resolve => setTimeout(resolve, 800));

            // Update local store (simulating backend response)
            if (user) {
