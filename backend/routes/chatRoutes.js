...
router.post('/', protect, async (req, res) => {
    try {
        ...
        const systemPrompt = `
            ...
            - Biological Energy: ${systemContext.energy}%
            - Cognitive Task Load: ${systemContext.cognitiveLoad}
            ...
            1. Priority One: If Burnout is HIGH, enforce restorative protocols (immediate rest).
            2. Priority Two: If Energy < 60%, suggest metabolic restoration (sleep/nutrition).
            3. Priority Three: If Domain scores < 60, suggest specific tactical balancing.
            4. Tone: Diagnostic, professional, yet empathetic. Be concise.
